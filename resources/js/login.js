;(function () {
  ...
  const dummyUsers = [
    {
      ...
      email: 'admin@satyaterrabhinneka.ac.id',
      nip: '1987001',
    },
    {
  ...
  function validateCredentials(username, password) {
    return dummyUsers.some((user) => user.username === username && user.password === password)
  }
  ...
  function validateEmailOrNIP(input) {
    return dummyUsers.some((user) => user.email === input || user.nip === input)
  }
  ...
  if (loginForm) {
    loginForm.addEventListener('submit', (ev) => {
      ...
      if (validateCredentials(u, p)) {
        showAlert(
          `<div style="display: flex; align-items: center; gap: 0.5rem;"><i class="bi bi-check-circle-fill" style="font-size: 1.3rem;"></i><div><strong>Berhasil!</strong><br><small>Anda akan diarahkan ke dashboard dalam beberapa detik...</small></div></div>`,
          'success'
        )
        ...
        showAlert(
          `<div style="display: flex; align-items: center; gap: 0.5rem;"><i class="bi bi-exclamation-circle-fill" style="font-size: 1.3rem;"></i><div><strong>Login Gagal</strong><br><small>Username atau password salah. Silakan coba lagi.</small></div></div>`,
          'danger'
        )
      }
  ...
  if (forgotForm) {
    forgotForm.addEventListener('submit', (ev) => {
      ...
      if (!input) {
        showForgotAlert(
          `<div style="display: flex; align-items: center; gap: 0.5rem;"><i class="bi bi-exclamation-circle-fill" style="font-size: 1.3rem;"></i><div><strong>Input Kosong</strong><br><small>Silakan masukkan email atau NIP terlebih dahulu.</small></div></div>`,
          'danger'
        )
        return false
      }
      ...
      if (validateEmailOrNIP(input)) {
        showForgotAlert(
          `<div style="display: flex; align-items: center; gap: 0.5rem;"><i class="bi bi-check-circle-fill" style="font-size: 1.3rem;"></i><div><strong>Berhasil!</strong><br><small>Instruksi pemulihan telah dikirim ke email Anda. Silakan cek inbox atau folder spam.</small></div></div>`,
          'success'
        )
        ...
        showForgotAlert(
          `<div style="display: flex; align-items: center; gap: 0.5rem;"><i class="bi bi-exclamation-circle-fill" style="font-size: 1.3rem;"></i><div><strong>Email/NIP Tidak Ditemukan</strong><br><small>Email atau NIP yang Anda masukkan tidak terdaftar dalam sistem.</small></div></div>`,
          'danger'
        )
      }
